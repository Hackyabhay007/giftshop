        ...
        {isMobile ? (
              ...
              {sliderData?.map((item) => (
                <SwiperSlide
                  ...
                  style={{
                    ...
                    height: "250px", // Set height for mobile slides
                    position: "relative",
                  }}
                >
                  {/* Image Container */}
                  ...
                  >
                    <Image
                      ...
                      width={200}
                      height={150}
                      objectFit="cover" // Make sure the image is contained within the area
                      className=""
                    />
                  </div>
          ...
          >
            {sliderData?.map((item) => (
              <SwiperSlide
                key={item.id}
                className="tp-slider-item tp-slider-height grid align-items-center"
