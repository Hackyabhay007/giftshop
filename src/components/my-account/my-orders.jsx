...
const MyOrders = ({ orderData, currentPage, setCurrentPage }) => {
  ...
  const { current_page, last_page, data, total } = orders || {};
    ...
    >
      {!sortedData?.length ? (
        ...
        <>
                      ...
                      >
                        <div>
                          ...
                          >
                            {item.products
                              .map(
                                (prod) => `${prod.name} (Qty: ${prod.quantity})`
                              )
                              .join(", ")}
                          </div>
                        </div>
          ...
          >
            Showing {(current_page - 1) * 10 + 1} to{" "}
            {Math.min(current_page * 10, total)} of {total} orders
          </div>
        </>
      )}
    </div>
