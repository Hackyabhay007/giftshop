...
const StyledInstallButton = ({
  ...
  const buttonStyle = {
    background: isHovered 
      ? 'linear-gradient(145deg, #990100, #800000)' 
      : 'linear-gradient(145deg, #ffffff, #f0f0f0)',
    color: isHovered ? '#ffffff' : '#990100',
    padding: '15px 30px',
    borderRadius: '50px',
    border: '2px solid #990100',
    cursor: 'pointer',
  ...
  return (
    <AppInstallButton
      style={buttonStyle}
      className={`styled-install-btn ${className}`}
      onInstallSuccess={onInstallSuccess}
          ...
          <div className="row align-items-center">
            ...
            <div className="col-md-6">
              <div className="install-content">
                ...
                <div className="mb-4">
                  <StyledInstallButton
                    onInstallSuccess={() => console.log('Installation successful')}
                    onInstallFailure={(error) => console.error('Installation failed:', error)}
                  >
                    Install Now
                  </StyledInstallButton>
                </div>
