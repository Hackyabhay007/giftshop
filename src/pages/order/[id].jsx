            ...
            <div className="container">
              ...
              >
                ...
                {(isCanceled || status === "canceled") && (
                  ...
                  >
                    ...
                    {payment_type === "online" &&
                      " You will receive a refund in some time."}
                  </div>
                )}
              ...
              {payment_type === "online" && refund_id && (
                ...
                >
                  ...
                  <p>
                    <strong>Refund ID:</strong> {refund_id}
                  </p>
                  <p>
                    <strong>Refund Amount:</strong> ₹
                    {Number(refund_amount).toFixed(2)}
                  </p>
                  <p>
              ...
              {order.coupon_used ? (
                <div className="tp-coupon-date">
                  <span className="font-weight-bold text-dark">
                    Appied Coupon : {order.coupon_used}
                  </span>
                </div>
              ) : (
                ""
                ...
                <div className="col-xl-12">
                  <ReactToPrint
                    trigger={() => (
                      <button
                        type="button"
                        className="tp-invoice-print tp-btn tp-btn-black d-none"
                      >
                        <span className="mr-5">
